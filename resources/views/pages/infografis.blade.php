  ...
  <div class="container" data-aos="fade-up">
    <div class="row align-items-center gy-4">
      ...
      <div class="col-lg-4 text-center">
        <img src="assets/images/people/ALI MANSUR.jpeg" alt="Kepala Desa" class="img-fluid rounded-circle shadow-sm" style="max-width: 320px;">
      ...
      <div class="col-lg-8">
        ...
        <p class="sambutan-text">
          Assalamu’alaikum wr.wb. Puji syukur senantiasa kita panjatkan kehadirat Allah SWT Tuhan Yang Maha Esa
          yang telah melimpahkan rahmat, taufik dan hidayahnya Kepada kita sekalian sehingga Desa Binjai dapat membangun
          website Desa Binjai. Sejalan dengan penerapan informasi dalam pelayanan publik, maka website Desa Binjai yang
          dibangun ini merupakan suatu tuntutan Teknologi Informasi (TI) yang berkembang pesat pada saat ini...
        </p>
      </div>
    ...
    <section id="stats" class="stats section dark-background">
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="subheading">
          ...
          <p>Dibawah ini tertera sekilas data penduduk di Desa Jatirejo.</p>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="2464" data-purecounter-duration="1" class="purecounter"></span>
              <p>Penduduk</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="1225" data-purecounter-duration="1" class="purecounter"></span>
              <p>Laki-Laki</p>
            </div>
          </div><!-- End Stats Item -->
